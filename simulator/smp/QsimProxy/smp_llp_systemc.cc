...
//! @verbatim
//!                                              ------------      ------------     ------------
//!      -----------       -----------          |   memory   |    |   memory   |    |   SystemC  |
//!     | processor |     | processor |         | controller |    | controller |    |   Adapter  |
//!      -----------       -----------           ------------      ------------     ------------
//!           |                 |                     |                  |                |
//!        ----------           ----------            |                  |                |
//!       | L1 cache |         | L1 cache |           |                  |                |
...
//!  -------------------------------------------------------------------------------------------
//!       ------------         ------------       ------------      ------------     ------------ 
//!      | NetIntface |       | NetIntface |     | NetIntface |    | NetIntface |    | NetIntface |  
//!       ------------         ------------       ------------      ------------     ------------ 
//!  -------------------------------------------------------------------------------------------
//! @endverbatim
//!
//!
#include "../common/sysBuilder_llp_systemc.h"
...
#define REDIRECT_COUT
    ...
    sysBuilder.build_system(args, argv[2], N_LPs, SysBuilder_llp_systemc::PART_1);
