#include "sysBuilder_llp_systemc.h"
...
//====================================================================
//====================================================================
SysBuilder_llp_systemc :: SysBuilder_llp_systemc(const char* fname)
{
    try {
...
SysBuilder_llp_systemc :: ~SysBuilder_llp_systemc()
{
...
//====================================================================
//====================================================================
void SysBuilder_llp_systemc :: config_system()
{
...
//====================================================================
//====================================================================
void SysBuilder_llp_systemc :: config_components()
{
    try {
...
//====================================================================
void SysBuilder_llp_systemc :: build_system(FrontendType type, int n_lps, vector<string>& args, int part)
{
...
//====================================================================
void SysBuilder_llp_systemc :: build_system(Qsim::OSDomain* qsim_osd, vector<string>& args)
{
    assert(m_conf_read == true);
...
//====================================================================
void SysBuilder_llp_systemc :: build_system(vector<string>& args, const char* appFile, int n_lps, int part)
{
    assert(m_conf_read == true);
...
void SysBuilder_llp_systemc :: create_qsimclient_nodes(int n_lps, vector<string>& args, int part)
{
...
//====================================================================
//====================================================================
void SysBuilder_llp_systemc :: create_qsimlib_nodes(Qsim::OSDomain* qsim_osd, vector<string>& args)
{
    switch(m_proc_builder->get_proc_type()) {
   /*     case ProcBuilder::PROC_ZESTO: {*/
            //if(args.size() != 0) {
...
//====================================================================
//====================================================================
void SysBuilder_llp_systemc :: create_qsimproxy_nodes(vector<string>& args, const char* appFile, int n_lps, int part)
{
...
//====================================================================
//! @arg \c n_lps  number of LPs
void SysBuilder_llp_systemc :: create_trace_nodes(int n_lps, vector<string>& args, int part)
{
    switch(m_proc_builder->get_proc_type()) {
       /* case ProcBuilder::PROC_ZESTO: {*/
            //if(args.size() != 1) {
...
//====================================================================
//====================================================================
void SysBuilder_llp_systemc :: create_nodes(int type, int n_lps, int part)
{
...
//====================================================================
//====================================================================
void SysBuilder_llp_systemc :: do_partitioning_1_part(int n_lps)
{
...
//====================================================================
//====================================================================
void SysBuilder_llp_systemc :: do_partitioning_y_part(int n_lps)
{
...
void SysBuilder_llp_systemc :: dep_injection_for_mcp()
{
...
//====================================================================
//====================================================================
void SysBuilder_llp_systemc :: dep_injection_for_iris()
{
    if(m_cache_builder->get_type() == CacheBuilder::MCP_CACHE || m_cache_builder->get_type() == CacheBuilder::MCP_L1L2) {
...
//====================================================================
//====================================================================
void SysBuilder_llp_systemc :: connect_components()
{
    if(m_qsim_builder)
...
//====================================================================
//====================================================================
void SysBuilder_llp_systemc :: pre_simulation()
{
...
//====================================================================
//====================================================================
void SysBuilder_llp_systemc :: print_config(ostream& out)
{
    for(int i=0; i<MAX_NODES; i++) {
        out << "node " << i;
...
//====================================================================
//====================================================================
void SysBuilder_llp_systemc :: print_stats(ostream& out)
{
